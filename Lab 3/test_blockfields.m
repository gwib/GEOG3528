...
colorbar
figure
imagesc(results_stones) % Fig 3 - concentration of stones in depth
title('Concentration of stones in depth')
xlabel('years')
ylabel('Depth [m]')
colorbar
figure
imagesc(results_fines) %Fig 4 - concentration of fines in depth
title('Concentration of fines in depth')
xlabel('years')
ylabel('Depth [m]')
colorbar


% Erosion of bedrock with constant volume
